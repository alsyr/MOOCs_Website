...
public class edx {
  ...
  public static void main(String[] args) throws IOException, InstantiationException,
    ...
    String url1 = "https://www.edx.org/course?page=0";
    String url2 = "https://www.edx.org/course?page=1";
    String url3 = "https://www.edx.org/course?page=2";
    String url4 = "https://www.edx.org/course?page=3";
    String url5 = "https://www.edx.org/course?page=4";
    String url6 = "https://www.edx.org/course?page=5";
    ...
    for (int a = 0; a < pgcrs.size(); a++) {
      ...
      for (int j = 0; j < link.size(); j++) {
        ...
        String crsurl = "https://www.edx.org" + link.get(j).attr("href");
        //Get the Course Url from href tag and add to www.edx.org to get the full URL to the course
        ...
        //String SCrsDesrp = SCrsDesrpTemp.substring(0, (SCrsDesrpTemp.length()-5));
        // To get the course description and remove the extra characters at the end.
        SCrsDesrpTemp = SCrsDesrpTemp.replace("'", "''");
        SCrsDesrpTemp = SCrsDesrpTemp.replace(",", "");
        String CrsImg;
        if (a == 0 || a == 1) {
        ...
        //The following is used to insert scraped data into your database table.
        // Need to uncomment all database related code to run this.
        String query = "insert into course_data values(null,'" + CourseName + "','" + SCrsDesrpTemp +
            "','" + CrsDes + "','" + crsurl + "','" + youtube + "'," + StrDate + "," + crsduration +
            ",'" + CrsImg + "','','Edx')";
        System.out.println(query);
        //statement.executeUpdate(query);// skip writing to database;
        // focus on data printout to a text file instead.
        //statement.close();
      }
    }
    //connection.close();
