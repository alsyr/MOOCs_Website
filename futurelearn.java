  ...
  public static void main(String[] args) throws IOException, InstantiationException,
    ...
    for (int a = 0; a < pgcrs.size(); a++) {
      ...
      for (int f = 0; f < link.size(); f++) {
        String course_link = "https://www.futurelearn.com" + link.get(f).attr("href");
...
//				}
        ...
        String value;
        value = "(" + (courseNumber) + ", '" + title + "', '" + short_desc + "', '" + long_desc +
            "', '" + course_link + "', '" + video_link + "', '" + start_date + "', " + course_length +
            ", '" + course_image + "', '" + category + "', '" + site + "', " + course_fee + ", '" +
            language + "', '" + certificate + "', '" + university + "', '" + time_scraped + "'),";
        file.println(value);

        for (int j = 0; j < profname.size(); j++) {
          String value2;
          value2 = "(" + (profNumber++) + ", '" + profname.get(j) + "', '" + profimage.get(j) +
              "', " + (courseNumber) + "),";
